...
- [OC LORE COMPLIANCE] IF YOU OWN A PRIMAGEN OR RARE PROTOGEN (AS DEFINED BY ZOR) YOU ARE PROHIBITED FROM USING THIS CODE UNTIL FURTHER NOTICE. VIOLATING THIS CONSTRAINT MAY RESULT IN BLOCKS ON VIRTUALLY ALL PLATFORMS.
